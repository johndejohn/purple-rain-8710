...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/purple-rain-8710)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/purple-rain-8710
```

A live public deployment of this template is available at [https://purple-rain-8710.templates.workers.dev](https://purple-rain-8710.templates.workers.dev)
